var facebook_ail_click_open_chat_tab_windows8 = {
    ...
    series: [{
		name: 'firefox',
		data: [
			[Date.UTC(2017, 8, 5), 55.56],
			[Date.UTC(2017, 8, 5), 55.56],
			[Date.UTC(2017, 8, 5), 55.56],
			[Date.UTC(2017, 8, 5), 55.56],
			[Date.UTC(2017, 8, 5), 55.56],
			[Date.UTC(2017, 8, 5), 77.78],
			[Date.UTC(2017, 8, 5), 77.78],
		...
		name: 'chrome',
		data: [
			[Date.UTC(2017, 8, 5), 100.0],
			[Date.UTC(2017, 8, 5), 111.11],
			[Date.UTC(2017, 8, 5), 111.11],
			[Date.UTC(2017, 8, 5), 33.33],
			[Date.UTC(2017, 8, 5), 44.44],
			[Date.UTC(2017, 8, 5), 66.67],
			[Date.UTC(2017, 8, 5), 77.78],
