var facebook_ail_type_comment_1_txt_windows8 = {
    ...
    series: [{
		...
		data: [
			...
			[Date.UTC(2017, 5, 8), 566.670000],
			[Date.UTC(2017, 5, 9), 133.330000],
